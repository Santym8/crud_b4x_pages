...
especieservice.myClass = BA.getDeviceClass ("b4a.example.especieservice");
especiepage.myClass = BA.getDeviceClass ("b4a.example.especiepage");
animalesservice.myClass = BA.getDeviceClass ("b4a.example.animalesservice");
animalpage.myClass = BA.getDeviceClass ("b4a.example.animalpage");
